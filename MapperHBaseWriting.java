...
public class MapperHBaseWriting extends
	...
	public void map(ImmutableBytesWritable row, Result columns, Context context)
	       throws IOException, InterruptedException {
               ...
               //Next 2 lines removes the hour (e.g. 00:00) from the timestamp, given strings: PickupDate & DropoffDate
               //String strNewPickupDate = PickupDate.substring(0,10);
               //String strNewDropoffDate = DropoffDate.substring(0, 10);
               
               // Mappper Jobs
               // Note that some jobs required string concatenation.
